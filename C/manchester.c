...
// Function for Manchester encoding (using XNOR with clock)
...
int main() {
    char *input;   // dynamic string for bitstream
    ...
    // Determine number of bits automatically
    n = strlen(input);
